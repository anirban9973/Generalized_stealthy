"""
Create folder structure for unbiased ground-state runs over chi0 and chi_gen,
copy CCO.out and ex_ground_slurm.sh into each chi_gen folder, write params.dat,
...
for chi0 in chi0_values:
    ...
    for chi_gen in chi_gen_values:
        ...
        # Write params.dat: line1=chi0, line2=chi_gen
